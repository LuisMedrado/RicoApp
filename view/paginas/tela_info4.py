...
class TelaInfo4(ctk.CTkFrame):
    def __init__(self, parent, voltar_callback, **kwargs):
        ...
        label_titulo = ctk.CTkLabel(
            self,
            text="Diversificação: o segredo da segurança",
        ...
        texto = (
            "Diversificar é distribuir seus investimentos em diferentes ativos, setores ou regiões. "
            "Esse é um dos princípios mais importantes para quem deseja investir com mais segurança.\n\n"
            "Imagine que você coloque todo o seu dinheiro em ações de uma única empresa. "
            "Se ela tiver problemas, você corre o risco de perder tudo. Agora, se seu dinheiro estiver dividido entre ações, "
            "fundos imobiliários, renda fixa e até investimentos no exterior, os riscos se equilibram.\n\n"
            "A diversificação reduz o impacto negativo de um único investimento e melhora as chances de bons resultados no longo prazo. "
            "É uma estratégia essencial para qualquer perfil de investidor, desde o conservador até o arrojado."
        )
...
if __name__ == "__main__":
    ...
    root.title("Tela Info 4")
    tela = TelaInfo4(root, voltar_callback=voltar)
